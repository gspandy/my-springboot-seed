...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
	...
	public void afterPropertiesSet() throws ServletException {
		...
		urlMap.put(SeedConstants.DEFAULT_SIGN_IN_PROCESSING_URL_FORM, ValidateCodeType.IMAGE);
		addUrlToMap(seedProperties.getValidateCode().getImage().getUrls(), ValidateCodeType.IMAGE);

		urlMap.put(SeedConstants.DEFAULT_SIGN_IN_PROCESSING_URL_MOBILE, ValidateCodeType.SMS);
		addUrlToMap(seedProperties.getValidateCode().getSms().getUrls(), ValidateCodeType.SMS);
		
		addUrlToMap(seedProperties.getValidateCode().getEmail().getUrls(), ValidateCodeType.EMAIL);
	}
